...
- **Flashcard maker** — offline decks with manual and bulk card creation, deck search, due-card review, answer reveal, mastery tracking, and lightweight spaced repetition through Again / Hard / Good ratings. Flashcards are included in backup/restore.
...
- **Room database** (`data/entity`, `data/dao`, `PunlaDatabase.kt`) mirroring your
  ...
  recurring rules, semesters/grade courses, flashcard decks/cards, and archives.
...
Punla 2.3 can import `punla-flashcards` JSON decks generated by ChatGPT. See `FLASHCARD_JSON_IMPORT.md` for the schema and workflow.
