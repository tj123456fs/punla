...
interface StudyMaterialDao {
    ...
    @Upsert suspend fun upsertTopic(item: StudyTopic)
    @Upsert suspend fun upsertTopics(items: List<StudyTopic>)
    ...
    @Upsert suspend fun upsertNote(item: StudyNote)
    @Upsert suspend fun upsertNotes(items: List<StudyNote>)
    ...
    @Upsert suspend fun upsertFormula(item: FormulaReference)
    @Upsert suspend fun upsertFormulas(items: List<FormulaReference>)
    ...
    @Upsert suspend fun upsertMistake(item: MistakeRecord)
    @Upsert suspend fun upsertMistakes(items: List<MistakeRecord>)
    ...
    @Upsert suspend fun upsertGoal(item: StudyGoal)
    @Upsert suspend fun upsertGoals(items: List<StudyGoal>)
    ...
    @Upsert suspend fun upsertPlanItem(item: StudyPlanItem)
    @Upsert suspend fun upsertPlanItems(items: List<StudyPlanItem>)
    ...
    @Upsert suspend fun upsertReviewProgress(item: StudyReviewProgress)
    @Upsert suspend fun upsertReviewProgress(items: List<StudyReviewProgress>)
    ...
    @Upsert suspend fun upsertFlashcardReviewEvent(item: FlashcardReviewEvent)
    @Upsert suspend fun upsertFlashcardReviewEvents(items: List<FlashcardReviewEvent>)
    ...
    @Upsert suspend fun upsertAnswerResult(item: QuizAnswerResult)
    @Upsert suspend fun upsertAnswerResults(items: List<QuizAnswerResult>)
    ...
    @Upsert suspend fun upsertBankItem(item: QuestionBankItem)
    @Upsert suspend fun upsertBankItems(items: List<QuestionBankItem>)
